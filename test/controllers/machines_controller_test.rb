...
class MachinesControllerTest < ActionController::TestCase
  ...
  test "should create machine" do
    assert_difference('Machine.count') do
      post :create, machine: { hostname: @machine.hostname, keys_file: @machine.keys_file, nickname: @machine.nickname, user: @machine.user }
    end
  ...
  test "should update machine" do
    patch :update, id: @machine, machine: { hostname: @machine.hostname, keys_file: @machine.keys_file, nickname: @machine.nickname, user: @machine.user }
    assert_redirected_to machine_path(assigns(:machine))
  end
